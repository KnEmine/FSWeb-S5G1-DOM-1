...
const ctaButton = (document.querySelector("button").textContent = "Başlayın");
const ctaImg = (document.querySelector("#cta-img").src =
  "http://localhost:9000/img/cta.png");

//ana bolum

document.getElementsByTagName("h4")[0].textContent = "Servisler";
document.getElementsByTagName("h4")[1].textContent = "Ürünler";
document.getElementsByTagName("h4")[2].textContent = "Vizyon";
document.getElementsByTagName("h4")[3].textContent = "Özellikler";
document.getElementsByTagName("h4")[4].textContent = "Hakkımızda";
